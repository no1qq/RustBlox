...
pub const PRESETS: &[FlagPreset] = &[
    FlagPreset {
        ...
        description: "Optimizes frame rates, minimizes level of detail distance, disables grass, and sets lowest texture and FRM quality.",
        flags: &[
    ...
    FlagPreset {
        name: "Max Visuals",
        description: "Enables 4x MSAA anti-aliasing, max texture detail, extended grass rendering distances, and maximum FRM quality level.",
        flags: &[
            ("DFFlagTextureQualityOverrideEnabled", "true"),
    ...
    FlagPreset {
        name: "OpenGL Backend",
        description: "Directs Roblox to use the OpenGL graphics renderer backend.",
        flags: &[("FFlagDebugGraphicsPreferOpenGL", "true")],
    },
    FlagPreset {
        name: "DirectX 11 Backend",
        description: "Directs Roblox to prioritize the DirectX 11 graphics renderer.",
        flags: &[("FFlagDebugGraphicsPreferD3D11", "true")],
    },
    FlagPreset {
        name: "Exclusive Fullscreen",
        description: "Enables manual Alt+Enter exclusive fullscreen toggle handling for lower input latency.",
